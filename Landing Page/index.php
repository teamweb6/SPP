...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">App SPP</a></h1>
  ...
  <!--   <li><a href="#">Drop Down 1</a></li>-->
            <!--<li class="dropdown"><a href="#"><span>Data Siswa Setiap Kelas</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
           <li><a href="#">
Data Siswa Kelas X </a></li>
           <li><a href="#">Data Siswa Kelas XI</a></li>
           <li><a href="#">Data Siswa Kelas XII</a></li>-->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>Welcome to the school tuition payment application</h1>
            <!--<h2>Selamat Datang</h2>-->
            <a href="register.php" class="download-btn"><i class="bx"></i>Register</a>
    ...
    <section id="features" class="features">
      <div class="container">
        <div class="section-title">
          <h2>About</h2>
          <p>Aplikasi atau website ini dibuat agar memudahkan para wali murid untuk membayar cicilan bulanan/ pembayaran spp. Selain itu juga app ini dapat memudahkan pengelolaan keuangan sekolah menjadi lebih komprensif.</p>
        </div>
            ...
            <div class="content d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  ...
                  <p>Program keahlian yang juga disebut Software Engineering ini bisa menjadi wadah yang tepat bagi kalian yang ingin mempelajari desain program dan mengembangkan sebuah software ataupun sistem operasi.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  <i class="bx bx-cube-alt"></i>
                  <h4>Samsung Tech Institute</h4>
                  <p>Tujuan Program Keahlian TKJ “Samsung Tech Institute” adalah keterampilan, pengetahuan dan sikap agar kompeten 
Mengoperasikan software dan Peralatan yang digunakan dalam memperbaiki smartphone, baik dalam bentuk hardware maupun software.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-images"></i>
                  <h4>Desain Komunikasi Visual</h4>
                  <p>Program keahlian DKV terutama mengeksplorasi konsep komunikasi dan ekspresi kreatif, dan menggunakan elemen visual dalam menyampaikan pesan untuk tujuan tertentu.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                  <i class="bx bx-shield"></i>
                  <h4>Busana Butik</h4>
                  <p>Program keahlian Busana Butik sering juga disebut dengan nama Fashion Design, program studi ini di pelajari teknik mendesain, belajar membuat pola, menjahit, dan seluk beluk produksi busana atau fashion.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                  <i class="bx bx-atom"></i>
                  <h4>Asisten Keperawatan</h4>
                  <p>Program keahlian asisten keperawatan merupakan program yang bertujuan untuk menghasilkan tenaga ahli dalam asistensi keperawatan yang terampil, kompeten dan professional di bidang pelayanan dasar keperawatan khususnya pemenuhan kebutuhan dasar manusia.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                  <i class="bx bx-id-card"></i>
                  <h4>Teknik Body Otomotif</h4>
                  <p>Teknik Bodi Otomotif (TBO) merupakah salah satu kompetensi keahlian untuk menjadi seorang teknisi dalam hal perbaikan bodi otomotif atau menjadi spesialis dalam hal bagian keindahan mobil tersebut yang dapat terdiri dari interior maupun exterior.</p>
                </div>
              </div>
            </div>
          </div>
...
<!-- End Testimonials Section -->
    ...
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Price</h2>
          <p>Jumlah harga per bulan yang harus dibayar setiap jurusan :</p>
<div class="row content">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 box" data-aos="fade-right">
            ...
            <h4>Rp. 95.000<span>per bulan</span></h4>
         <!--  <ul>
           ...
           <!--   <li><i class="bx bx-check"></i> Nec feugiat nisl pretium</li>
            ...
            <a href="#" class="get-started-btn">Bayar</a>
          </div>

          <div class="col-lg-4 box featured" data-aos="fade-up">
            <h3>Desain Komunikasi Visual</h3>
            <h4>Rp. 125.000<span>per bulan</span></h4>
         <!--  <ul>
              <li><i class="bx bx-check"></i> Quam adipiscing vitae proin</li>
              <!--<li><i class="bx bx-check"></i> Nec feugiat nisl pretium</li>
              <li><i class="bx bx-check"></i> Nulla at volutpat diam uteera</li>
...
<div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="assets/img/details-7.png" class="img-fluid" alt="">
          </div>

<div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="assets/img/details-8.png" class="img-fluid" alt="">
          </div>
...
<!-- End Frequently Asked Questions Section -->
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Jika ada yang ingin ditanyakan bisa menghubungi contact yang sudah tertera di bawah :</p>
        </div>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6 info">
                <i class="bx bx-map"></i>
                <h4>Address</h4>
                <p>Jawa Barat<br>Cirebon, CR 535022</p>
              </div>
              <div class="col-lg-6 info">
                <i class="bx bx-phone"></i>
                <h4>Call Us</h4>
                <p>+62 838 7811 9912<br>+62 831 2036 3229<br>+62 8953 9112 3212</p>
              </div>
              <div class="col-lg-6 info">
                <i class="bx bx-envelope"></i>
                <h4>Email Us</h4>
                <p>webteamsixx@gmail.com</p>
              </div>
              <div class="col-lg-6 info">
                <i class="bx bx-time-five"></i>
                <h4>Working Hours</h4>
                <p>Mon - Sat: 08.00AM to 03.00PM<br>Sunday: Close</p>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
   ...
   <!-- <div class="footer-newsletter">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Web Team Six</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
